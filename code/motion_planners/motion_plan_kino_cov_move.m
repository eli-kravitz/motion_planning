...
[node,ni,T,time,P] = goal_bias_rrt_kino_cov_move(q_start,q_goal,...
    p_goal,n,eps,v,x_lim,y_lim,l_car,w_car,v_lim,phi_lim,...
    v_dot_lim,phi_dot_lim,L,r,Q,P0,vel);

path_plotter_kino_cov_move(f1,node,T,q_start,l_car,w_car,L,P,vel,v);

% path_name = ['/Users/elikravitz/Desktop/CU_Classes/Current/'...
%     'Algorithmic_Motion_Planning/Final_Project/figs/move.avi'];
% f2 = road_plotter(v,x_lim,y_lim);
% path_vid_kino_cov_move(f2,node,T,q_start,l_car,w_car,L,P,vel,v,path_name)
